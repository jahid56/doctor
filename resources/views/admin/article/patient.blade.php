        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li><a href="{{ route('serialinfo', $profile['id']) }}">See Serial Info</a></li>
              <li class="active"><a href="{{ route('patientinfo', $profile['id']) }}">See Patient Info</a></li>
            </ul>
                  ...
                  <div class="user-block">
                        <span class="username">
                          <p>Name : &nbsp {{ $doctor->name }}</p>
            						  <p>Problem : &nbsp {{ $doctor->problem }}</p>
